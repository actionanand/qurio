import {t}from'./chunk-D0US1QpH.js';import {E as Ea,_ as _a,v as va,L as La,b as wa,A as Aa,o,c as ct,Y as Ye,s as st$1,a1 as a,a2 as lr,a3 as $c,a4 as ze,T as Ta,F as Fa,a5 as Ic,V as Vs}from'./chunk-BnBY5YJ7.js';import {m}from'./chunk-Cof8wN6c.js';import'./main-4YNI5R6H.js';var lt=Vs.pie,L={sections:new Map,showData:false},b=L.sections,O=L.showData,St=structuredClone(lt),xt=o(()=>structuredClone(St),"getConfig"),wt=o(()=>{b=new Map,O=L.showData,Fa();},"clear"),Ct=o(({label:t,value:a})=>{if(a<0)throw new Error(`"${t}" has invalid value: ${a}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);b.has(t)||(b.set(t,a),ct.debug(`added new section: ${t}, with value: ${a}`));},"addSection"),$t=o(()=>b,"getSections"),Dt=o(t=>{O=t;},"setShowData"),yt=o(()=>O,"getShowData"),st={getConfig:xt,clear:wt,setDiagramTitle:Aa,getDiagramTitle:wa,setAccTitle:La,getAccTitle:va,setAccDescription:_a,getAccDescription:Ea,addSection:Ct,getSections:$t,setShowData:Dt,getShowData:yt},Tt=o((t$1,a)=>{t(t$1,a),a.setShowData(t$1.showData),t$1.sections.map(a.addSection);},"populateDb"),bt={parse:o(async t=>{let a=await m("pie",t);ct.debug(a),Tt(a,st);},"parse")},At=o(t=>`
  .pieCircle{
